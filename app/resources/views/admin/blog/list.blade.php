                ...
                <form method="get">
                    <div class="row ">
                            ...
                            <div class="table-btn-css">
                                <a href="{{route('blogs.create')}}">
                                    <button type="button" class="btn btn-primary waves-effect waves-light">
                                        <span class="ti-xs ti ti-plus me-1"></span>{{__('lang.add_blog')}}
                                    </button>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3 display-inline-block mt-3">
                            ...
                            <a type="reset" class="btn btn-outline-secondary" href="{{ route('blogs.index') }}">{{__('lang.reset')}}</a>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td aria-colindex="2" role="cell" class="">
                                    <span class="b-avatar mr-1 badge-secondary rounded-circle">
                                        <span class="b-avatar-img">
                                            ...
                                            <img src="{{ isset($row->image) ? url('uploads/blog/'.$row->image) : 'uploads/Image-not-found.png/' }}" width="100px">
                                ...
                                <td>
                                    <a href="{{ route('blogs.updateStatus', $row->id) }}">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a onclick="showDeleteConfirmation('blog', {{ $row->id }})" class="dropdown-item">
                                                <i class="ti ti-trash me-1"></i>{{__('lang.delete')}}
                                            </a>
                                             <a href="{{ route('blog.translation', $row->id) }}" class="dropdown-item">

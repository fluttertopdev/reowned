        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
          ...
          <li class="nav-item dropdown-language dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                  @if(count($langList)>0)
                    ...
                    <li>
                      <a class="dropdown-item" href="{{ route('setting.setLanguage', ['lang' => $langRow->code]) }}" data-languages="{{$langRow->code }} ">
          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a
              ...
              data-bs-toggle="dropdown">
              <div class="avatar">
                <img src="{{ url('uploads/user/'.Auth::user()->image)}}" alt class="rounded-circle" />
              </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
              <li>
              ...
              <li>
                <div class="d-grid px-2 pt-2 pb-1">
                  <a class="btn btn-sm btn-danger d-flex" href="{{ url('admin/adminlogout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">

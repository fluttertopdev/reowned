...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-6">
           <h5 class="card-header">{{ $data ? __('lang.edit') : __('lang.add') }}</h5>
            <form class="card-body" action="{{ isset($data) ? route('item-listing-package.update') : route('item-listing-package.store') }}" method="POST" enctype="multipart/form-data" id="description-form">
                @csrf
                @if(isset($data))
    ...
    <div class="form-password-toggle">
        ...
        <div class="input-group input-group-merge">
            <input type="text" id="multicol-final-price" class="form-control" name="final_price" 
                   value="{{ old('final_price', $data->final_price ?? '') }}" placeholder="Final Price" readonly />
                    ...
                    <div class="col-md-6" id="days-input">
                        ...
                        <span class=" text-danger">*</span>
                        <input type="text" class="form-control" name="no_of_days" placeholder="{{__('lang.no_days')}}" value="{{ old('no_of_days', $data->no_of_days ?? '') }}" />
                    </div>
                    ...
                    <div class="col-md-6" id="item-input">
                        ...
                        <span class=" text-danger">*</span>
                        <input type="text" class="form-control" name="no_of_item" placeholder="{{__('lang.no_item')}}" value="{{ old('no_of_item', $data->no_of_item ?? '') }}" />
                    </div>

            ...
            <form class="card-body" action="{{ isset($data) ? route('slider.update') : route('slider.store') }}" method="POST" enctype="multipart/form-data" id="description-form">
                ...
                @endif
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control select2 form-select" name="type" id="type" onchange="toggleFields()">
        ...
        @endforeach
                    ...
                    <div class="col-md-6">
                        ...
                        <div>
                            ...
                            <img id="image-preview" src="{{ $data && $data->image ? asset('uploads/slider/' . $data->image) : asset('uploads/Image-not-found.png') }}" alt="Image Preview" style="width: 200px; border: 1px solid #ccc; display: block;" />
                        </div>
                    </div>
                </div>
                <div class="pt-6">

        ...
        <div class="card mt-4">
            <div class="card-header">
                <form method="get">
                    <div class="row ">
                        <div class="col-md-6">
                            <h5>{{__('lang.tag_list')}}</h5>
                        </div>
                        <div class="col-md-6">
                            <div class="table-btn-css">
                                <a href="{{route('tags.create')}}">
                                    <button type="button" class="btn btn-primary waves-effect waves-light">
                                        <span class="ti-xs ti ti-plus me-1"></span>{{__('lang.add_tag')}}
                                    </button>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3 display-inline-block mt-3">
                            ...
                            <a type="reset" class="btn btn-outline-secondary" href="{{ route('tags.index') }}">{{__('lang.reset')}}</a>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('tags.updateStatus', $row->id) }}">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('tags.edit', $row->id) }}" class="dropdown-item">
                                                <i class="ti ti-pencil me-1"></i>{{__('lang.edit')}}
                                            </a>
                                            <a onclick="showDeleteConfirmation('tags', {{ $row->id }})" class="dropdown-item">
                                                <i class="ti ti-trash me-1"></i>{{__('lang.delete')}}
                                            </a>
                                            <a href="{{ route('tags.translation', $row->id) }}" class="dropdown-item">

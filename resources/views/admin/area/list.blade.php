        ...
        <div class="card mt-4">
            <div class="card-header">
                <form method="get">
                    <div class="row ">
                        <div class="col-md-6">
                            <h5>{{__('lang.area_list')}}</h5>
                        </div>
                        <div class="col-md-6 d-flex justify-content-end">
                            <div class="table-btn-css">
                                <a href="{{route('area.form')}}">
                                    <button type="button" class="btn btn-primary waves-effect waves-light">
                                        <span class="ti-xs ti ti-plus me-1"></span>{{__('lang.add_area')}}
                                    </button>
                                </a>
                            </div>
                        ...
                        <div class="col-sm-3 display-inline-block mt-3">
                            ...
                            <a type="reset" class="btn btn-outline-secondary" href="{{ route('area.index') }}">{{__('lang.reset')}}</a>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a href="{{ route('area.form', $row->id) }}" class="dropdown-item">
                                                <i class="ti ti-pencil me-1"></i>{{__('lang.edit')}}
                                            </a>
                                            <a onclick="showDeleteConfirmation('area', {{ $row->id }})" class="dropdown-item">
...
<div class="modal fade" id="bulkUploadModal" tabindex="-1" aria-labelledby="bulkUploadModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{ route('area.bulkUpload') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="bulkUploadModalLabel">{{__('lang.bulk_upload_area')}}</h5>
                ...
                <div class="modal-footer">
                    <a href="{{ url('uploads/excelfile/areaimport.xlsx') }}" class="btn btn-info">

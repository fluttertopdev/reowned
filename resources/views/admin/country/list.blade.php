        ...
        <div class="card mt-4">
            <div class="card-header">
                <form method="get">
                    <div class="row ">
                        <div class="col-md-6">
                            <h5>{{__('lang.country_list')}}</h5>
                        </div>
                        <div class="col-md-6 d-flex justify-content-end">
                            <div class="table-btn-css">
                                <a href="{{route('country.form')}}">
                                    <button type="button" class="btn btn-primary waves-effect waves-light">
                                        <span class="ti-xs ti ti-plus me-1"></span>{{__('lang.add_country')}}
                                    </button>
                                </a>
                            </div>
                        ...
                        <div class="col-sm-3 display-inline-block mt-3">
                            ...
                            <a type="reset" class="btn btn-outline-secondary" href="{{ route('country.index') }}">{{__('lang.reset')}}</a>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('country.updateStatus', $row->id) }}">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a href="{{ route('country.form', $row->id) }}" class="dropdown-item">
                                                <i class="ti ti-pencil me-1"></i>{{__('lang.edit')}}
                                            </a>
                                            <a onclick="showDeleteConfirmation('country', {{ $row->id }})" class="dropdown-item">
...
<div class="modal fade" id="bulkUploadModal" tabindex="-1" aria-labelledby="bulkUploadModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{ route('country.bulkUpload') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="bulkUploadModalLabel">{{__('lang.bulk_upload_country')}}</h5>
                ...
                <div class="modal-footer">
                    <a href="{{ url('uploads/excelfile/countryimport.xlsx') }}" class="btn btn-info">

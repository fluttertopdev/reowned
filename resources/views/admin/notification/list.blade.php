                ...
                <form method="get">
                    <div class="row ">
                        ...
                        <div class="col-sm-3 display-inline-block mt-3">
                            ...
                            <a type="reset" class="btn btn-outline-secondary" href="{{ route('notification.index') }}">{{__('lang.reset')}}</a>
            ...
            <div class="card-body">
                @can('delete-notification')
                    <button type="button" class="btn btn-danger mb-3" id="bulkDeleteBtn">
                        <i class="ti ti-trash"></i> {{ __('lang.bulk_delete') }}
                    </button>
                @endcan
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $row->title }}</td>
                                <td title="{{ strip_tags($row->msg) }}">
                                    {{ Str::words(strip_tags($row->msg), 100, '...') }}
                                </td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a href="{{ route('notification.form', $row->id) }}" class="dropdown-item">

...
<html>
<head>
    <title>{{ __('lang.item_packages_list') }}</title>
    <style>
        table {
            width: 100%;
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            {{-- If you want translation for dynamic values --}}
            <td>{{ __('lang.' . $row->days) }}</td>
            <td>{{ $row->no_of_days }}</td>
            <td>{{ __('lang.' . $row->item) }}</td>

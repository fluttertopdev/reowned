        ...
        <div class="col">
            <div class="card mb-3">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <button
                            type="button"
                            class="nav-link @if(Request::is('admin/settings/google-map*')) active @endif"
                            data-bs-toggle="tab"
                            data-bs-target="#form-tabs-google-map"
                            role="tab"
                            aria-selected="false"
                            >
                        ...
                        <li class="nav-item">
                            <button
                            type="button"
                            class="nav-link @if(Request::is('admin/settings/adsense-ads-setting*')) active @endif"
                            data-bs-toggle="tab"
                            data-bs-target="#form-tabs-adsense-ads"
                            role="tab"
                            aria-selected="false"
                            >
                ...
                <div class="tab-content">
                    ...
                    <!-- Google map settings -->
                    <div class="tab-pane fade @if(Request::is('admin/settings/google-map*')) active show @endif" id="form-tabs-google-map" role="tabpanel">
                        <form method="POST" id="update-record" action="{{route('setting.update')}}" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="page_name" value="google-map">
                            @csrf
                            <div class="row">
                            @foreach($result as $row)
                                @include('admin/setting/google_map_settings')
                            @endforeach 
                            </div>
                            <div class="row">
                                <div class="col-12 d-flex flex-sm-row flex-column mt-2">
                    ...
                    <!-- Adsense Ad -->
                    <div class="tab-pane fade @if(Request::is('admin/settings/adsense-ads-setting*')) active show @endif" id="form-tabs-adsense-ads" role="tabpanel">
                        <form method="POST" id="update-record" action="{{route('setting.update')}}" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="page_name" value="adsense-ads-setting">
                            @csrf
                            <div class="row">
                            @foreach($result as $row)

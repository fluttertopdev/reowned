                ...
                <form method="get">
                    <div class="row ">
                        ...
                        <div class="col-sm-3 display-inline-block mt-3">
                            ...
                            <a type="reset" class="btn btn-outline-secondary" href="{{ route('userqueries.index') }}">{{__('lang.reset')}}</a>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                              @can('user-queries-view')
                                            <a href="{{ route('userqueries.form', $row->id) }}" class="dropdown-item">
                                                <i class="ti ti-eye me-1"></i>{{__('lang.view')}}
                                            </a>
                                               @endcan
                                                 @can('user-queries-delete')

    ...
    <div class="authentication-inner row m-0">
      ...
      <div class="d-flex col-12 col-lg-4 align-items-center authentication-bg p-sm-12 p-6">
        <div class="w-px-400 mx-auto mt-12 mt-5">
          ...
          <form id="formAuthentication" class="mb-6" action="{{route('staffpassword.forgot')}}" method="POST">
            @csrf
            <div class="mb-6">
          ...
          <div class="text-center">
            <a href="{{route('staffloginlogin.index')}}" class="d-flex align-items-center justify-content-center">

...
<head>
  ...
  <title>{{__('lang.staff_login')}}</title>
    ...
    <div class="authentication-inner row m-0">
      ...
      <div class="d-flex col-12 col-lg-4 align-items-center authentication-bg p-sm-12 p-6">
        <div class="w-px-400 mx-auto mt-12 pt-5">
          ...
          @endif
          <h4 class="mb-1">{{__('lang.staff_login')}}</h4>
          <p class="mb-6"> {{__('lang.login')}}</p>

          <form id="login-form" class="mb-6" action="{{route('stafflogin.dologin')}}" method="POST">
            @csrf
            <div class="mb-6">
            ...
            <div class="my-8">
              <div class="d-flex w-100">
                <div class="ms-auto text-end">
                  <a href="{{route('staffforgotpassword.index')}}">

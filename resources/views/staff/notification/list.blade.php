        ...
        <div class="card mt-4">
            <div class="card-header">
                <form method="get">
                    <div class="row ">
                        <div class="col-md-6">
                            <h5>{{__('lang.notification_list')}}</h5>
                        </div>
                    
                        <div class="col-md-6">
                                @if (in_array('add-notification', \Helpers::staffgetAssignedPermissions()))
                            <div class="table-btn-css">
                                <a href="{{route('staffNotification.form')}}">
                                    <button type="button" class="btn btn-primary waves-effect waves-light">
                                        <span class="ti-xs ti ti-plus me-1"></span>{{__('lang.add_notification')}}
                                    </button>
                                </a>
                            </div>
                                 @endif
                        ...
                        <div class="col-sm-3 display-inline-block mt-3">
                            <input type="text" class="form-control dt-full-name" placeholder="{{__('lang.title')}}" name="name" value="@if(isset($_GET['name']) && $_GET['name']!=''){{$_GET['name']}}@endif">
                        </div>
                        <div class="col-sm-3 display-inline-block mt-3">
                        ...
                        <div class="col-sm-3 display-inline-block mt-3">
                            ...
                            <a type="reset" class="btn btn-outline-secondary" href="{{ route('staffNotification.index') }}">{{__('lang.reset')}}</a>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            @if (in_array('view-notification', \Helpers::staffgetAssignedPermissions()))
                                            <a href="{{ route('staffNotification.form', $row->id) }}" class="dropdown-item">
                                                <i class="ti ti-eye me-1"></i>{{__('lang.view')}}
                                            </a>
                                                 @endif
                                             @if (in_array('delete-notification', \Helpers::staffgetAssignedPermissions()))
                                            <a onclick="showDeleteConfirmation('notification', {{ $row->id }})" class="dropdown-item">

...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card mb-6">
            ...
            <form class="card-body" action="{{ isset($data) ? route('staffAdvertisementpackage.update') : route('staffAdvertisementpackage.store') }}" method="POST" enctype="multipart/form-data" id="description-form">
                @csrf
                @if(isset($data))
                ...
                <div class="pt-6">
                    ...
                    <a href="{{route('staffAdvertisementpackage.index')}}"

            ...
            <div class="card-header">
                <form method="get">
                    <div class="row ">
                        ...
                        <div class="col-md-6">
                         @if (in_array('add-advertisementpackage', \Helpers::staffgetAssignedPermissions()))
                            <div class="table-btn-css">
                                <a href="{{route('staffAdvertisementpackage.form')}}">
                        ...
                        <div class="col-sm-3 display-inline-block mt-3">
                            ...
                            <a type="reset" class="btn btn-outline-secondary" href="{{ route('staffAdvertisementpackage.index') }}">{{__('lang.reset')}}</a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ \Helpers::commonDateFormate($row->created_at) }}</td>
                                 @can('status')
                                <td>
                                    <a href="{{ route('staffAdvertisementpackage.updateStatus', $row->id) }}">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            @if (in_array('update-advertisementpackage', \Helpers::staffgetAssignedPermissions()))
                                            <a href="{{ route('staffAdvertisementpackage.form', $row->id) }}" class="dropdown-item">
                                                <i class="ti ti-pencil me-1"></i>{{__('lang.edit')}}
                                            </a>
                                                @endif
                                                 @if (in_array('delete-advertisementpackage', \Helpers::staffgetAssignedPermissions()))

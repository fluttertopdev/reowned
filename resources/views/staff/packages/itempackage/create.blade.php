    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-6">
           <h5 class="card-header">{{ $data ? __('lang.edit') : __('lang.add') }}</h5>
            <form class="card-body" action="{{ isset($data) ? route('staffitemPackages.update') : route('staffitemPackages.store') }}" method="POST" enctype="multipart/form-data" id="description-form">
                @csrf
                @if(isset($data))
                ...
                <div class="row g-6">
                  ...
                  <input type="hidden" name="user_id" value="{{ Auth::guard('staff')->check() ? Auth::guard('staff')->id() : '' }}">
                    <!-- Price -->
                   <div class="col-md-6">
        ...
        <div class="input-group input-group-merge">
            <input type="text" id="multicol-final-price" class="form-control" name="final_price" 
                ...
                <div class="pt-6">
                    ...
                    <a href="{{route('staffitemPackages.index')}}" 

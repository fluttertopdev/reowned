            ...
            <div class="card-header">
                <form method="get">
                    <div class="row ">
                        ...
                        <div class="col-md-6">
                            @if (in_array('add-itempackage', \Helpers::staffgetAssignedPermissions()))
                            <div class="table-btn-css">
                                <a href="{{route('staffitemPackages.form')}}">
                        ...
                        <div class="col-sm-3 display-inline-block mt-3">
                            ...
                            <a type="reset" class="btn btn-outline-secondary" href="{{ route('staffitemPackages.index') }}">{{__('lang.reset')}}</a>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('staffitemPackages.updateStatus', $row->id) }}">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                              @if (in_array('update-itempackage', \Helpers::staffgetAssignedPermissions()))
                                            <a href="{{ route('staffitemPackages.form', $row->id) }}" class="dropdown-item">
                                                <i class="ti ti-pencil me-1"></i>{{__('lang.edit')}}
                                            </a>
                                               @endif
                                               @if (in_array('delete-itempackage', \Helpers::staffgetAssignedPermissions()))
